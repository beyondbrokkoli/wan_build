...
enum {
    ...
    VK_BUFFER_USAGE_2_SHADER_DEVICE_ADDRESS_BIT = 0x20000,
    ...
    VK_IMAGE_USAGE_HOST_TRANSFER_BIT = 0x400000,
    ...
    VK_DESCRIPTOR_SET_LAYOUT_CREATE_PUSH_DESCRIPTOR_BIT = 0x1,
    ...
    VK_PIPELINE_CACHE_CREATE_READ_ONLY_BIT = 0x2,
    VK_PIPELINE_CACHE_CREATE_USE_APPLICATION_STORAGE_BIT = 0x4,
    VK_MEMORY_HEAP_SEU_SAFE_BIT = 0x4,
    ...
    VK_PRIVATE_DATA_SLOT_CREATE_RESERVED_0_BIT_NV = 0x1,
    ...
    VK_BUFFER_CREATE_RESERVED_7_BIT_IMG = 0x80,
    VK_IMAGE_CREATE_RESERVED_21_BIT_IMG = 0x200000,
    VK_SHADER_CREATE_RESERVED_17_BIT_IMG = 0x20000,
    VK_RENDERING_RESERVED_9_BIT_IMG = 0x200,
    VK_RENDER_PASS_CREATE_RESERVED_3_BIT_IMG = 0x8,
    ...
    VK_BUFFER_USAGE_2_DESCRIPTOR_HEAP_BIT_EXT = 0x10000000,
    VK_IMAGE_CREATE_DESCRIPTOR_HEAP_CAPTURE_REPLAY_BIT_EXT = 0x10000,
    ...
    VK_SHADER_CREATE_DESCRIPTOR_HEAP_BIT_EXT = 0x400,
    ...
    VK_TENSOR_CREATE_DESCRIPTOR_HEAP_CAPTURE_REPLAY_BIT_ARM = 0x8,
    ...
    VK_SWAPCHAIN_CREATE_PRESENT_TIMING_BIT_EXT = 0x200,
    ...
    VK_SHADER_CREATE_RESERVED_16_BIT_KHR = 0x10000,
    ...
    VK_SUBPASS_DESCRIPTION_TILE_SHADING_APRON_BIT_QCOM = 0x100,
    ...
    VK_PIPELINE_STAGE_2_COMMAND_PREPROCESS_BIT_EXT = 0x20000,
    VK_ACCESS_2_COMMAND_PREPROCESS_READ_BIT_EXT = 0x20000,
    VK_ACCESS_2_COMMAND_PREPROCESS_WRITE_BIT_EXT = 0x40000,
    ...
    VK_EXTERNAL_SEMAPHORE_HANDLE_TYPE_SCI_SYNC_OBJ_BIT_NV = 0x20,
    ...
    VK_SWAPCHAIN_CREATE_RESERVED_5_BIT_EXT = 0x20,
    ...
    VK_GEOMETRY_INSTANCE_FORCE_OPACITY_MICROMAP_2_STATE_BIT_EXT = 0x10,
    VK_GEOMETRY_INSTANCE_DISABLE_OPACITY_MICROMAPS_BIT_EXT = 0x20,
    VK_BUILD_ACCELERATION_STRUCTURE_ALLOW_OPACITY_MICROMAP_UPDATE_BIT_EXT = 0x40,
    VK_BUILD_ACCELERATION_STRUCTURE_ALLOW_DISABLE_OPACITY_MICROMAPS_BIT_EXT = 0x80,
    VK_BUILD_ACCELERATION_STRUCTURE_ALLOW_OPACITY_MICROMAP_DATA_UPDATE_BIT_EXT = 0x100,
    ...
    VK_IMAGE_USAGE_RESERVED_24_BIT_COREAVI = 0x1000000,
    ...
    VK_EXTERNAL_MEMORY_HANDLE_TYPE_OH_NATIVE_BUFFER_BIT_OHOS = 0x8000,
    ...
    VK_IMAGE_USAGE_TENSOR_ALIASING_BIT_ARM = 0x800000,
    ...
    VK_TENSOR_CREATE_DESCRIPTOR_BUFFER_CAPTURE_REPLAY_BIT_ARM = 0x4,
    VK_TENSOR_VIEW_CREATE_DESCRIPTOR_BUFFER_CAPTURE_REPLAY_BIT_ARM = 0x1,
    ...
    VK_SWAPCHAIN_CREATE_PRESENT_ID_2_BIT_KHR = 0x40,
    ...
    VK_SWAPCHAIN_CREATE_PRESENT_WAIT_2_BIT_KHR = 0x80,
    ...
    VK_SWAPCHAIN_CREATE_DEFERRED_MEMORY_ALLOCATION_BIT_KHR = 0x8,
    ...
    VK_DEVICE_QUEUE_CREATE_INTERNALLY_SYNCHRONIZED_BIT_KHR = 0x4,
    ...
    VK_TENSOR_USAGE_DATA_GRAPH_BIT_ARM = 0x20,
    VK_BUFFER_USAGE_2_DATA_GRAPH_FOREIGN_DESCRIPTOR_BIT_ARM = 0x20000000,
    ...
    VK_VIDEO_CODEC_OPERATION_DECODE_VP9_BIT_KHR = 0x8,
    ...
    VK_QUEUE_RESERVED_12_BIT_EXT = 0x1000,
    ...
    VK_MEMORY_HEAP_TILE_MEMORY_BIT_QCOM = 0x8,
    VK_BUFFER_USAGE_TILE_MEMORY_BIT_QCOM = 0x8000000,
    VK_BUFFER_USAGE_2_TILE_MEMORY_BIT_QCOM = 0x8000000,
    VK_IMAGE_USAGE_TILE_MEMORY_BIT_QCOM = 0x8000000,
    ...
    VK_VIDEO_ENCODE_INTRA_REFRESH_BIT_KHR = 0x4,
    VK_VIDEO_ENCODE_H264_CAPABILITY_B_PICTURE_INTRA_REFRESH_BIT_KHR = 0x400,
    VK_VIDEO_ENCODE_H265_CAPABILITY_B_PICTURE_INTRA_REFRESH_BIT_KHR = 0x800,
    VK_VIDEO_ENCODE_AV1_CAPABILITY_COMPOUND_PREDICTION_INTRA_REFRESH_BIT_KHR = 0x20,
    ...
    VK_VIDEO_ENCODE_H264_CAPABILITY_MB_QP_DIFF_WRAPAROUND_BIT_KHR = 0x200,
    ...
    VK_BUILD_ACCELERATION_STRUCTURE_ALLOW_CLUSTER_OPACITY_MICROMAPS_BIT_NV = 0x1000,
    ...
    VK_PIPELINE_STAGE_COMMAND_PREPROCESS_BIT_EXT = 0x20000,
    ...
    VK_PIPELINE_CACHE_CREATE_INTERNALLY_SYNCHRONIZED_MERGE_BIT_KHR = 0x8,
    ...
    VK_SHADER_CREATE_RESERVED_8_BIT_EXT = 0x100,
    VK_SHADER_CREATE_RESERVED_9_BIT_EXT = 0x200,
    ...
    VK_QUERY_POOL_CREATE_RESET_BIT_KHR = 0x1,
    VK_DEPENDENCY_EXTENSION_586_BIT_IMG = 0x10,
    VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VIDEO_MAINTENANCE_2_FEATURES_KHR = 1000586000,
    VK_VIDEO_SESSION_CREATE_INLINE_SESSION_PARAMETERS_BIT_KHR = 0x20,
    ...
    VK_SHADER_STAGE_RESERVED_15_BIT_NV = 0x8000,
    VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PIPELINE_OPACITY_MICROMAP_FEATURES_ARM = 1000596000,
    VK_VIDEO_ENCODE_FEEDBACK_RESERVED_3_BIT_KHR = 0x8,
    VK_VIDEO_ENCODE_FEEDBACK_RESERVED_4_BIT_KHR = 0x10,
    VK_VIDEO_ENCODE_FEEDBACK_RESERVED_5_BIT_KHR = 0x20,
    VK_VIDEO_ENCODE_FEEDBACK_RESERVED_6_BIT_KHR = 0x40,
    VK_VIDEO_ENCODE_FEEDBACK_RESERVED_7_BIT_KHR = 0x80,
    VK_VIDEO_ENCODE_FEEDBACK_RESERVED_8_BIT_KHR = 0x100,
    VK_VIDEO_ENCODE_FEEDBACK_RESERVED_9_BIT_KHR = 0x200,
    ...
    VK_WAYLAND_SURFACE_CREATE_DISABLE_COLOR_MANAGEMENT = 0x1,
    ...
    VK_RENDER_PASS_CREATE_PER_LAYER_FRAGMENT_DENSITY_BIT_VALVE = 0x4,
    VK_RENDERING_PER_LAYER_FRAGMENT_DENSITY_BIT_VALVE = 0x20,
    ...
    VK_INSTANCE_CREATE_RESERVED_616_BIT_EXT = 0x2,
    VK_SWAPCHAIN_CREATE_RESERVED_8_BIT_EXT = 0x100,
    ...
    VK_IMAGE_CREATE_FRAGMENT_DENSITY_MAP_OFFSET_BIT_EXT = 0x8000,
    VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_ZERO_INITIALIZE_DEVICE_MEMORY_FEATURES_EXT = 1000620000,
    VK_MEMORY_ALLOCATE_ZERO_INITIALIZE_BIT_EXT = 0x8,
    ...
    VK_BUILD_ACCELERATION_STRUCTURE_RESERVED_10_BIT_KHR = 0x400,
    VK_SHADER_CREATE_RESERVED_12_BIT_EXT = 0x1000,
    VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_64_BIT_INDEXING_FEATURES_EXT = 1000627000,
    VK_SHADER_CREATE_64_BIT_INDEXING_BIT_EXT = 0x8000,
    ...
    VK_RESOLVE_MODE_CUSTOM_BIT_EXT = 0x20,
    ...
    VK_RENDERING_LOCAL_READ_CONCURRENT_ACCESS_CONTROL_BIT_KHR = 0x100,
    ...
    VK_QUEUE_RESERVED_13_BIT_EXT = 0x2000,
    VK_IMAGE_USAGE_RESERVED_29_BIT_KHR = 0x20000000,
    VK_IMAGE_USAGE_RESERVED_30_BIT_KHR = 0x40000000,
    VK_IMAGE_CREATE_RESERVED_22_BIT_KHR = 0x400000,
    VK_SHADER_CREATE_RESERVED_18_BIT_KHR = 0x40000,
    VK_QUEUE_RESERVED_11_BIT_ARM = 0x800,
    VK_SUBGROUP_FEATURE_PARTITIONED_BIT_EXT = 0x100,
    VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_SUBGROUP_PARTITIONED_FEATURES_EXT = 1000662000,
    VK_COMMAND_BUFFER_USAGE_RESERVED_3_BIT_HUAWEI = 0x8,
    VK_SHADER_STAGE_RESERVED_16_BIT_HUAWEI = 0x10000,
    VK_IMAGE_USAGE_RESERVED_16_BIT_HUAWEI = 0x10000,
    VK_IMAGE_USAGE_RESERVED_27_BIT_HUAWEI = 0x20000,
    VK_IMAGE_ASPECT_RESERVED_11_BIT_HUAWEI = 0x800,
    VK_COMMAND_BUFFER_USAGE_RESERVED_4_BIT_HUAWEI = 0x10,
    ...
    VK_PIPELINE_CREATE_2_RAY_TRACING_SKIP_BUILT_IN_PRIMITIVES_BIT_KHR = 0x1000,
    ...
    VK_PIPELINE_STAGE_2_SHADING_RATE_IMAGE_BIT_NV = 0x400000,
    VK_ACCESS_2_SHADING_RATE_IMAGE_READ_BIT_NV = 0x800000,
    ...
    VK_FORMAT_FEATURE_2_SAMPLED_IMAGE_FILTER_CUBIC_BIT_EXT = 0x2000,
    ...
    VK_BUFFER_USAGE_2_RAY_TRACING_BIT_NV = 0x400,
...
_G.VK_FORMAT_FEATURE_2_HOST_IMAGE_TRANSFER_BIT = 0x400000000000ULL
_G.VK_ACCESS_2_VIDEO_DECODE_READ_BIT_KHR = 0x800000000ULL
_G.VK_ACCESS_2_VIDEO_DECODE_WRITE_BIT_KHR = 0x1000000000ULL
_G.VK_PIPELINE_CREATE_2_RESERVED_46_BIT_IMG = 0x400000000000ULL
_G.VK_PIPELINE_CREATE_2_EXECUTION_GRAPH_BIT_AMDX = 0x100000000ULL
_G.VK_PIPELINE_CREATE_2_DESCRIPTOR_HEAP_BIT_EXT = 0x1000000000ULL
_G.VK_ACCESS_2_SAMPLER_HEAP_READ_BIT_EXT = 0x200000000000000ULL
_G.VK_ACCESS_2_RESOURCE_HEAP_READ_BIT_EXT = 0x400000000000000ULL
_G.VK_ACCESS_2_RESERVED_46_BIT_INTEL = 0x400000000000ULL
_G.VK_PIPELINE_CREATE_RESERVED_44_BIT_KHR = 0x100000000000ULL
_G.VK_ACCESS_2_VIDEO_ENCODE_READ_BIT_KHR = 0x2000000000ULL
_G.VK_ACCESS_2_VIDEO_ENCODE_WRITE_BIT_KHR = 0x4000000000ULL
_G.VK_FORMAT_FEATURE_2_RESERVED_44_BIT_QCOM = 0x100000000000ULL
_G.VK_ACCESS_2_SHADER_TILE_ATTACHMENT_READ_BIT_QCOM = 0x8000000000000ULL
_G.VK_ACCESS_2_SHADER_TILE_ATTACHMENT_WRITE_BIT_QCOM = 0x10000000000000ULL
_G.VK_ACCESS_2_DESCRIPTOR_BUFFER_READ_BIT_EXT = 0x20000000000ULL
_G.VK_PIPELINE_STAGE_2_SUBPASS_SHADER_BIT_HUAWEI = 0x8000000000ULL
_G.VK_ACCESS_2_INVOCATION_MASK_READ_BIT_HUAWEI = 0x8000000000ULL
_G.VK_PIPELINE_STAGE_2_INVOCATION_MASK_BIT_HUAWEI = 0x10000000000ULL
_G.VK_ACCESS_2_SHADER_BINDING_TABLE_READ_BIT_KHR = 0x10000000000ULL
_G.VK_ACCESS_2_MICROMAP_READ_BIT_EXT = 0x100000000000ULL
_G.VK_ACCESS_2_MICROMAP_WRITE_BIT_EXT = 0x200000000000ULL
_G.VK_PIPELINE_STAGE_2_CLUSTER_CULLING_SHADER_BIT_HUAWEI = 0x20000000000ULL
_G.VK_PIPELINE_CREATE_2_RAY_TRACING_ALLOW_SPHERES_AND_LINEAR_SWEPT_SPHERES_BIT_NV = 0x200000000ULL
_G.VK_FORMAT_FEATURE_2_ACCELERATION_STRUCTURE_RADIUS_BUFFER_BIT_NV = 0x8000000000000ULL
_G.VK_FORMAT_FEATURE_2_LINEAR_COLOR_ATTACHMENT_BIT_NV = 0x4000000000ULL
_G.VK_FORMAT_FEATURE_2_WEIGHT_IMAGE_BIT_QCOM = 0x400000000ULL
_G.VK_FORMAT_FEATURE_2_WEIGHT_SAMPLED_IMAGE_BIT_QCOM = 0x800000000ULL
_G.VK_FORMAT_FEATURE_2_BLOCK_MATCHING_BIT_QCOM = 0x1000000000ULL
_G.VK_FORMAT_FEATURE_2_BOX_FILTER_SAMPLED_BIT_QCOM = 0x2000000000ULL
_G.VK_FORMAT_FEATURE_2_TENSOR_SHADER_BIT_ARM = 0x8000000000ULL
_G.VK_FORMAT_FEATURE_2_TENSOR_IMAGE_ALIASING_BIT_ARM = 0x80000000000ULL
_G.VK_ACCESS_2_OPTICAL_FLOW_READ_BIT_NV = 0x40000000000ULL
_G.VK_ACCESS_2_OPTICAL_FLOW_WRITE_BIT_NV = 0x80000000000ULL
_G.VK_FORMAT_FEATURE_2_OPTICAL_FLOW_IMAGE_BIT_NV = 0x10000000000ULL
_G.VK_FORMAT_FEATURE_2_OPTICAL_FLOW_VECTOR_BIT_NV = 0x20000000000ULL
_G.VK_FORMAT_FEATURE_2_OPTICAL_FLOW_COST_BIT_NV = 0x40000000000ULL
_G.VK_PIPELINE_CREATE_2_ENABLE_LEGACY_DITHERING_BIT_EXT = 0x400000000ULL
_G.VK_PIPELINE_CREATE_2_DISALLOW_OPACITY_MICROMAP_BIT_ARM = 0x2000000000ULL
_G.VK_BUFFER_USAGE_2_COMPRESSED_DATA_DGF1_BIT_AMDX = 0x200000000ULL
_G.VK_PIPELINE_CREATE_2_CAPTURE_DATA_BIT_KHR = 0x80000000ULL
_G.VK_PIPELINE_STAGE_2_CONVERT_COOPERATIVE_VECTOR_MATRIX_BIT_NV = 0x100000000000ULL
_G.VK_PIPELINE_STAGE_2_DATA_GRAPH_BIT_ARM = 0x40000000000ULL
_G.VK_ACCESS_2_DATA_GRAPH_READ_BIT_ARM = 0x800000000000ULL
_G.VK_ACCESS_2_DATA_GRAPH_WRITE_BIT_ARM = 0x1000000000000ULL
_G.VK_FORMAT_FEATURE_2_TENSOR_DATA_GRAPH_BIT_ARM = 0x1000000000000ULL
_G.VK_BUFFER_USAGE_2_RESERVED_34_BIT_EXT = 0x400000000ULL
_G.VK_FORMAT_FEATURE_2_RESERVED_60_BIT_EXT = 0x1000000000000000ULL
_G.VK_PIPELINE_STAGE_2_COPY_INDIRECT_BIT_KHR = 0x400000000000ULL
_G.VK_FORMAT_FEATURE_2_COPY_IMAGE_INDIRECT_DST_BIT_KHR = 0x800000000000000ULL
_G.VK_PIPELINE_STAGE_2_MEMORY_DECOMPRESSION_BIT_EXT = 0x200000000000ULL
_G.VK_ACCESS_2_MEMORY_DECOMPRESSION_READ_BIT_EXT = 0x80000000000000ULL
_G.VK_ACCESS_2_MEMORY_DECOMPRESSION_WRITE_BIT_EXT = 0x100000000000000ULL
_G.VK_BUFFER_USAGE_2_MEMORY_DECOMPRESSION_BIT_EXT = 0x100000000ULL
_G.VK_FORMAT_FEATURE_2_VIDEO_ENCODE_QUANTIZATION_DELTA_MAP_BIT_KHR = 0x2000000000000ULL
_G.VK_FORMAT_FEATURE_2_VIDEO_ENCODE_EMPHASIS_MAP_BIT_KHR = 0x4000000000000ULL
_G.VK_BUFFER_USAGE_2_PREPROCESS_BUFFER_BIT_EXT = 0x80000000ULL
_G.VK_PIPELINE_CREATE_2_INDIRECT_BINDABLE_BIT_EXT = 0x4000000000ULL
_G.VK_PIPELINE_CREATE_2_RESERVED_35_BIT_KHR = 0x800000000ULL
_G.VK_PIPELINE_CREATE_2_PER_LAYER_FRAGMENT_DENSITY_BIT_VALVE = 0x10000000000ULL
_G.VK_PIPELINE_CREATE_2_RESERVED_41_BIT_KHR = 0x20000000000ULL
_G.VK_PIPELINE_CREATE_2_64_BIT_INDEXING_BIT_EXT = 0x80000000000ULL
_G.VK_FORMAT_FEATURE_2_DEPTH_COPY_ON_COMPUTE_QUEUE_BIT_KHR = 0x10000000000000ULL
_G.VK_FORMAT_FEATURE_2_DEPTH_COPY_ON_TRANSFER_QUEUE_BIT_KHR = 0x20000000000000ULL
_G.VK_FORMAT_FEATURE_2_STENCIL_COPY_ON_COMPUTE_QUEUE_BIT_KHR = 0x40000000000000ULL
_G.VK_FORMAT_FEATURE_2_STENCIL_COPY_ON_TRANSFER_QUEUE_BIT_KHR = 0x80000000000000ULL
_G.VK_FORMAT_FEATURE_2_RESERVED_56_BIT_ARM = 0x100000000000000ULL
_G.VK_FORMAT_FEATURE_2_RESERVED_57_BIT_ARM = 0x200000000000000ULL
_G.VK_FORMAT_FEATURE_2_RESERVED_58_BIT_ARM = 0x400000000000000ULL
_G.VK_PIPELINE_STAGE_2_RESERVED_49_BIT_EXT = 0x2000000000000ULL
_G.VK_ACCESS_2_RESERVED_62_BIT_EXT = 0x4000000000000000ULL
_G.VK_ACCESS_2_RESERVED_63_BIT_EXT = 0x8000000000000000ULL
_G.VK_PIPELINE_CREATE_2_RESERVED_45_BIT_EXT = 0x200000000000ULL
_G.VK_PIPELINE_STAGE_2_RESERVED_47_BIT_KHR = 0x800000000000ULL
_G.VK_ACCESS_2_RESERVED_60_BIT_KHR = 0x1000000000000000ULL
_G.VK_ACCESS_2_RESERVED_61_BIT_KHR = 0x2000000000000000ULL
_G.VK_BUFFER_USAGE_2_RESERVED_35_BIT_KHR = 0x800000000ULL
_G.VK_BUFFER_USAGE_2_RESERVED_36_BIT_KHR = 0x1000000000ULL
_G.VK_PIPELINE_CREATE_2_RESERVED_47_BIT_AMD = 0x800000000000ULL
_G.VK_PIPELINE_STAGE_2_RESERVED_43_BIT_ARM = 0x80000000000ULL
_G.VK_ACCESS_2_RESERVED_49_BIT_ARM = 0x2000000000000ULL
_G.VK_ACCESS_2_RESERVED_50_BIT_ARM = 0x4000000000000ULL
_G.VK_FORMAT_FEATURE_2_RESERVED_47_BIT_ARM = 0x800000000000ULL
_G.VK_PIPELINE_CREATE_2_RESERVED_48_BIT_HUAWEI = 0x1000000000000ULL
_G.VK_BUFFER_USAGE_2_RESERVED_37_BIT_HUAWEI = 0x2000000000ULL
_G.VK_PIPELINE_STAGE_2_RESERVED_48_BIT_HUAWEI = 0x1000000000000ULL
_G.VK_FORMAT_FEATURE_2_RESERVED_61_BIT_HUAWEI = 0x2000000000000000ULL
_G.VK_FORMAT_FEATURE_2_HOST_IMAGE_TRANSFER_BIT_EXT = 0x400000000000ULL
_G.VK_PIPELINE_STAGE_2_SUBPASS_SHADING_BIT_HUAWEI = 0x8000000000ULL
